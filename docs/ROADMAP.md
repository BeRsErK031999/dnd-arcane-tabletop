...
Источник требований: Word-документ `TRP game builder.docx`, полученный 2026-07-15. Текст и 12 встроенных макетов сопоставлены с текущим приложением. Этапы 0-15 ниже остаются архивом уже созданного технического фундамента; текущая работа ведётся по этапам 16-22.
...
- Нет переносимого import/export проекта вместе с локальными ассетами.
...
Статус: запланировано следующей.

Входит:

- единый формат пакета проекта с version/schema marker;
- JSON кампании и все используемые локальные ассеты;
...
## Этап 17. Рабочая область по макету
...
## Этап 18. Пользовательские слои `Карта / ГМ / Токены`
...
## Этап 19. Независимые viewport и масштаб
...
## Этап 20. Управление экраном игроков
...
## Этап 21. Экран игроков и live-проекция
